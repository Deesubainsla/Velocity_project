                                    ...
                                    <table class="table mb-0 listingData dt-responsive" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            {rfplist && rfplist.map((rfp) => (
                                                <Listrfp key={rfp.id} rfpid={rfp.rfp_id} inquotes='true' id={rfp.id} rfpno={rfp.rfp_no} tittle={rfp.item_name} lastdate={rfp.last_date} min={rfp.minimum_price} max={rfp.maximum_price} status={rfp.rfp_status} />
                                            ))}
